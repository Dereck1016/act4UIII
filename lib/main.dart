...
class PaginaSesion extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        centerTitle: true,
        title: const Text('Negocio Perfumeria.',
            style: TextStyle(color: Colors.white)),
        backgroundColor: const Color(0xff203e91),
        elevation: 8,
      ),
      body: Padding(
      ...
      body: Center(
        child: Column(
          ...
          children: [
            Image(
                image: NetworkImage(
                    "https://raw.githubusercontent.com/Dereck1016/img_flutlab/main/perfumes.jpg")),
